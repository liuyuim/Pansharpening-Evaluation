...
I_MS_LR = double(imread('E:\Code-Papers\FusionBenchmark\Data\GF1\1\MS-Pan_Orth\MS.tif'));

%%% PAN image
% I_PAN = double(imread('16MAY02131229-P2AS-055670633040_01_P001.TIF'));
I_PAN = double(imread('E:\Code-Papers\FusionBenchmark\Data\GF1\1\MS-Pan_Orth\pan.tif'));
%% Set parameters
