...
%
        %%modified by WLG 2022-12-13
       % in extreme case, denominator of Q-index will zero，and return a
       % "nan" vaule for a lcoal patch. therefor, this patch should be
       % excluded for caculating the average of the whole image
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:Nb-1
    for j = i+1:Nb 
       ...
       tmpFlag1 = isnan(Qmap_exp);%"nan"labelled as true
       tmpFlag2 = isnan(Qmap_fused);
       tmpFlag = tmpFlag1 | tmpFlag2; 

       %ignore nan valuse
       Qmap_exp(tmpFlag==true) = [];
       Qmap_fused(tmpFlag==true) = [];
