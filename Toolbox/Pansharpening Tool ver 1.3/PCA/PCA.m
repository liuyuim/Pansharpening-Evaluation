...
% 
% References:
%           [Chavez89]      P. S. Chavez Jr. and A. W. Kwarteng, 揈xtracting spectral contrast in Landsat Thematic Mapper image data using selective principal
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% modified by WLG： 20220325 have  replaced princomp by pca, after 2012;
%%%%
...
% [W,PCAData] = princomp(imageLR);% have been replaced by pca, after 2012
